...
@optional
- (void)bubbleMenuButtonWillExpand:(MPBubbleMenu *)expandableView;
- (void)bubbleMenuButtonDidExpand:(MPBubbleMenu *)expandableView;
- (void)bubbleMenuButtonWillCollapse:(MPBubbleMenu *)expandableView;
- (void)bubbleMenuButtonDidCollapse:(MPBubbleMenu *)expandableView;

@end

@interface MPBubbleMenu : UIView <UIGestureRecognizerDelegate>
