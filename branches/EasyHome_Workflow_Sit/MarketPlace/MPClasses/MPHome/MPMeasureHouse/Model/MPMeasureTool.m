...
+ (BOOL)isMeasureDataOverCurrent:(NSInteger)year
...
+ (NSDictionary *)getCurrentDate {
    ...
    NSLog(@"%@",[NSString stringWithFormat:@"%ld年%ld月",year,month]);
    NSLog(@"%@",[NSString stringWithFormat:@"%ld%ld%ld",day,[comps hour],[comps minute]]);
    return dict;
}
