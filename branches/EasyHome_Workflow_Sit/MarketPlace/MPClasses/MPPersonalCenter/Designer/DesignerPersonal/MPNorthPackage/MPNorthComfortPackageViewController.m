/**
 * @file    MPNorthComfortPackageViewController.m
 * @brief   the from of MPNorthComfortPackageViewController.
 * @author  Xue
 * @version 1.0
 * @date    2016-01-19
 */
...
{
    UITextField *nameTextField;                //<! the textField of name.
    UITextField *phoneTextField;               //<! the textField of phone.
    UITextField *detailAddressTextField;       //<! the textField of detail address.
    UIButton *addressButton;                   //<! the button of address.
    MPAddressSelectedView *pickView;           //<! the pickview of select address.
    NSDictionary *consumers_informationDict;   //<! the dictionary of consumer information.
    UILabel *addressLabel;                     //<! the label of address show.
