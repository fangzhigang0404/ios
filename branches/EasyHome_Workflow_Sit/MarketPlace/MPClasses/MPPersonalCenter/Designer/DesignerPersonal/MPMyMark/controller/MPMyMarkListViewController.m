/**
 * @file    MPMyMarkListViewController.m
 * @brief   the frame of MPMyMarkListViewController.
 * @author  Xue
 * @version 1.0
 * @date    2016-01-19
 */
...
{
    MPMyMarkListView *_myMarkView;   //<! _listView the view for table.
    NSMutableArray *markArray;       //<! markArray bidding array for datasource.
    NSMutableArray *markingArray;    //<! markingArray bid array for datasource.
    NSMutableArray *loseBidArray;    //<! loseBidArray no bid array for datasource.
    NSString *tableType;             //<! tableview type.
